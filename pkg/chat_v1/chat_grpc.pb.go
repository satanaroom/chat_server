...
type ChatV1_ConnectChatClient interface {
	Recv() (*ConnectChatResponse, error)
	grpc.ClientStream
}
...
func (x *chatV1ConnectChatClient) Recv() (*ConnectChatResponse, error) {
	m := new(ConnectChatResponse)
...
type ChatV1_ConnectChatServer interface {
	Send(*ConnectChatResponse) error
	grpc.ServerStream
}
...
func (x *chatV1ConnectChatServer) Send(m *ConnectChatResponse) error {
